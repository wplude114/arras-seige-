...
function drawMinimapAndDebug(spacing, alcoveSize, GRAPHDATA) {
    ...
    // Text
    if (global.showDebug) {
        drawText("arras Ultimate Siege", x + len, y - 50 - 5 * 14 - 2, 15, "#1081E5", "right");
        ...
        drawText("arras.io*", x + len, y - 50 - 2 * 14 - 2, 15, "#1081E5", "right");
    ...
    } else drawText("arras.io*", x + len, y - 22 - 2 * 14 - 2, 15, "#1081E5", "right");
}
