...
let generatorMatrix = [
    [ "egg"           , "gem"                , "jewel"                  , "crasher"             , "sentry"               , "shinySentry"        , "EggRelic"           , "primordialEgg"          , "sphere"       ],
    [ "square"        , "shinySquare"        , "legendarySquare"        , "shadowSquare"        , "rainbowSquare"        , "transSquare"        , "SquareRelic"        , "primordialSquare"       , "cube"         ],
    [ "triangle"      , "shinyTriangle"      , "legendaryTriangle"      , "shadowTriangle"      , "rainbowTriangle"      , "transTriangle"      , "TriangleRelic"      , "primordialTriangle"     , "tetrahedron"  ],
    [ "pentagon"      , "shinyPentagon"      , "legendaryPentagon"      , "shadowPentagon"      , "rainbowPentagon"      , "transPentagon"      , "PentagonRelic"      , "primordialPentagon"     , "octahedron"   ],
...
Class.developer.UPGRADES_TIER_0 = ["tanks", "bosses", "spectator", "levels", "teams", "eggGenerator", "testing", "addons"]
    ...
    Class.bosses.UPGRADES_TIER_0 = ["sentries", "elites", "mysticals", "nesters", "rogues", "rammers", "entrestrials", "terrestrials", "celestials", "eternals", "devBosses"]
        ...
        Class.mysticals.UPGRADES_TIER_0 = ["sorcerer", "betaSorcerer", "summoner", "enchantress", "exorcistor", "shaman", 'betaExorcistor', 'alphaExorcistor', 'omegaExorcistor', "emperorExorcistor"]
        Class.nesters.UPGRADES_TIER_0 = ["nestKeeper", "nestWarden", "nestGuardian", "nestWatcher"]
        Class.rogues.UPGRADES_TIER_0 = ["roguePalisade", "rogueArmada", "julius", "genghis", "napoleon"]
	    Class.rammers.UPGRADES_TIER_0 = ["bob", "nemesis"]
		Class.entrestrials.UPGRADES_TIER_0 = ["th", "ze", "ga", "ha", "de", "the", "testent", "finalent"]
