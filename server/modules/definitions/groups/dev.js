...
// Testing tanks
Class.barrelDecoTest = {
    PARENT: "basic",
    LABEL: "Barrel Deco Test",
    GUNS: [
        {
            POSITION: {LENGTH: 8,WIDTH: 10,ASPECT: 1, X: 10,Y: 0,ANGLE: 0,DELAY: 0},
            PROPERTIES: {
        ...
        {
            POSITION: {LENGTH: 23,WIDTH: 6,ASPECT: 1, X: 0,Y: 0,ANGLE: 0,DELAY: 0},
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.fake]),
                TYPE: "bullet",
            }
...
Class.nav.UPGRADES_TIER_0 = ["tanks", "bosses"] // makes things easier
    Class.tanks.UPGRADES_TIER_0 = ["basic", "protoDread", "unavailable", ["whirlwind", "basic"], ["whirlwind", "arenaCloser"]]
        Class.unavailable.UPGRADES_TIER_0 = ["flail", "whirlwind"]
            Class.flail.UPGRADES_TIER_2 = ["doubleFlail", "mace", "flangle", "lancer","lobber"]
    ...
    Class.bosses.UPGRADES_TIER_0 = ["sentries", "elites", "mysticals", "nesters", "rogues", "rammers", "entrestrials", "terrestrials", "celestials", "eternals"]
		...
		Class.entrestrials.UPGRADES_TIER_0 = ["th", "ze", "ga", "ha", "de", "the", "testent", "finalent","Ti"]
