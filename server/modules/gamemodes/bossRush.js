...
class BossRush {
    constructor() {
        this.waveCodes = [
            ...
            ran.chooseN(oldGroups.nesters, 4).concat(ran.chooseN(oldGroups.ohhh, 2)).concat(ran.chooseN(oldGroups.celestials, 5)),
            ...
            ran.chooseN(oldGroups.elite, 5).concat(ran.chooseN(oldGroups.celestrials, 2)).concat(ran.chooseN(oldGroups.ohhh, 3)),
            ran.chooseN(oldGroups.eternals, 1).concat(ran.chooseN(oldGroups.celestials, 1)),
            ran.chooseN(oldGroups.mysticals, 3).concat(ran.chooseN(oldGroups.strange, 2)).concat(ran.chooseN(oldGroups.terrestrials, 4)),
        ];
        this.bossChoices = [
